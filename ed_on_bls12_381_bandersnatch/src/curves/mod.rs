...
impl ModelParameters for BandersnatchParameters {
    ...
    #[rustfmt::skip]
    const COFACTOR_INV: Fr = MontFp!(Fr, "9831726595336160714896451345284868594481866920080427688839802480047265754601");
}
...
impl MontgomeryModelParameters for BandersnatchParameters {
    ...
    #[rustfmt::skip]
    const COEFF_B: Fq = MontFp!(Fq, "25465760566081946422412445027709227188579564747101592991722834452325077642517");
...
#[rustfmt::skip]
const TE_GENERATOR_X: Fq = MontFp!(Fq, "18886178867200960497001835917649091219057080094937609519140440539760939937304");
/// y coordinate for TE curve generator
#[rustfmt::skip]
const TE_GENERATOR_Y: Fq = MontFp!(Fq, "19188667384257783945677642223292697773471335439753913231509108946878080696678");
...
#[rustfmt::skip]
const SW_GENERATOR_Y: Fq = MontFp!(Fq, "12663882780877899054958035777720958383845500985908634476792678820121468453298");
...
impl SWModelParameters for BandersnatchParameters {
    ...
    #[rustfmt::skip]
    const COEFF_A: Self::BaseField = MontFp!(Fq, "10773120815616481058602537765553212789256758185246796157495669123169359657269");

    /// COEFF_B = 29569587568322301171008055308580903175558631321415017492731745847794083609535
    #[rustfmt::skip]
    const COEFF_B: Self::BaseField = MontFp!(Fq, "29569587568322301171008055308580903175558631321415017492731745847794083609535");
