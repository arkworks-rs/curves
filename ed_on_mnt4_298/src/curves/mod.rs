...
impl ModelParameters for EdwardsParameters {
    ...
    #[rustfmt::skip]
    const COFACTOR_INV: Fr = MontFp!(Fr, "29745142885578832859584328103315528221570304936126890280067991221921526670592508030983158");
}
...
#[rustfmt::skip]
const GENERATOR_X: Fq = MontFp!(Fq, "282406820114868156776872298252698015906762052916420164316497572033519876761239463633892227");

/// GENERATOR_Y =
/// 452667754940241021433619311795265643711152068500301853535337412655162600774122192283142703
#[rustfmt::skip]
const GENERATOR_Y: Fq = MontFp!(Fq, "452667754940241021433619311795265643711152068500301853535337412655162600774122192283142703");
