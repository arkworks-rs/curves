use ark_ec::{models::mnt6::{MNT6Parameters, MNT6}, short_weierstrass::SWCurveConfig};
use ark_ff::{biginteger::BigInteger320, BigInt, Fp3, MontFp};
...
impl MNT6Parameters for Parameters {
    const TWIST: Fp3<Self::Fp3Config> = Fp3::<Self::Fp3Config>::new(FQ_ZERO, FQ_ONE, FQ_ZERO);
    const TWIST_COEFF_A: Fp3<Self::Fp3Config> =
        Fp3::<Self::Fp3Config>::new(FQ_ZERO, FQ_ZERO, g1::Parameters::COEFF_A);
