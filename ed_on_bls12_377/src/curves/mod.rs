...
impl ModelParameters for EdwardsParameters {
    ...
    #[rustfmt::skip]
    const COFACTOR_INV: Fr = MontFp!(Fr, "527778859339273151515551558673846658209717731602102048798421311598680340096");
}
...
impl MontgomeryModelParameters for EdwardsParameters {
    ...
    #[rustfmt::skip]
    const COEFF_A: Fq = MontFp!(Fq, "3990301581132929505568273333084066329187552697088022219156688740916631500114");
    ...
    #[rustfmt::skip]
    const COEFF_B: Fq = MontFp!(Fq, "4454160168295440918680551605697480202188346638066041608778544715000777738925");
...
#[rustfmt::skip]
const GENERATOR_X: Fq = MontFp!(Fq, "4497879464030519973909970603271755437257548612157028181994697785683032656389");
