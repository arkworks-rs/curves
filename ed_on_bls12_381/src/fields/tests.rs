...
#[test]
fn test_fr_add() {
    let f1 = Fr::new(BigInteger::new([
        0xc81265fb4130fe0c,
        0xb308836c14e22279,
        0x699e887f96bff372,
        0x84ecc7e76c11ad,
    ]));
    let f2 = Fr::new(BigInteger::new([
        0x71875719b422efb8,
        0x43658e68a93612,
        0x9fa756be2011e833,
        0xaa2b2cb08dac497,
    ]));
    let f3 = Fr::new(BigInteger::new([
        0x3999bd14f553edc4,
        0xb34be8fa7d8b588c,
        0x945df3db6d1dba5,
        0xb279f92f046d645,
...
#[test]
fn test_fr_bytes() {
    let f1_from_repr = Fr::new(BigInteger::new([
        0xc81265fb4130fe0c,
        0xb308836c14e22279,
        0x699e887f96bff372,
        0x84ecc7e76c11ad,
...
#[test]
fn test_fr_from_str() {
    let f100_from_repr = Fr::new(BigInteger::new([0x64, 0, 0, 0]));
