...
impl SWModelParameters for Parameters {
    /// COEFF_A = [240, 0]
    const COEFF_A: Fq2 = field_new!(Fq2, field_new!(Fq, "240"), field_new!(Fq, "0"),);
...
#[rustfmt::skip]
pub const G2_GENERATOR_X_C0: Fq = field_new!(Fq, "3742867872338536021971219193407057626975566811775929228638115610845414823755734136602223916420662890679205212867815");

/// G2_GENERATOR_X_C1 =
#[rustfmt::skip]
pub const G2_GENERATOR_X_C1: Fq = field_new!(Fq, "2008970337784971958599114573863246208442825790877271736434783886837659225024554344101831904846457859657000371883048");

/// G2_GENERATOR_Y_C0 =
#[rustfmt::skip]
pub const G2_GENERATOR_Y_C0: Fq = field_new!(Fq, "347020557560111175564150279686487416538085532798697633906066128669670325197422119639641125873165591545442034801173");

/// G2_GENERATOR_Y_C1 =
#[rustfmt::skip]
pub const G2_GENERATOR_Y_C1: Fq = field_new!(Fq, "3002750085289950562156391971969303286031832683890522668239999505933394032768942051901168474820339778663917384775384");
...
impl SWUParams for Parameters {    
    const XI : Fq2 = field_new!(Fq2, field_new!(Fq, "-1"), field_new!(Fq, "-2"),); //a nonsquare in Fq ietf standard
    const ZETA: Fq2 = field_new!(Fq2, field_new!(Fq, "1"), field_new!(Fq, "2"),);  //arbitatry primitive root of unity (element)
    const XI_ON_ZETA_SQRT: Fq2 = field_new!(Fq2, field_new!(Fq, "1"),field_new!(Fq, "0"),); ////square root of THETA=Xi/Zeta
