...
use ark_ff::{MontFp, BigInt, Field, Zero};
...
// PSI_X = 1/(u+1)^((p-1)/3)
pub const P_POWER_ENDOMORPHISM_COEFF_0 : Fq2 = MontFp!(
    Fq2,
    FQ_ZERO,
    MontFp!(
       Fq,
...
// PSI_Y = 1/(u+1)^((p-1)/2)
pub const P_POWER_ENDOMORPHISM_COEFF_1: Fq2 = MontFp!(
    Fq2,
    MontFp!(
       Fq,
...
impl WBParams for Parameters
{
    ...
    const PHI_X_NOM: &'static [<Self::IsogenousCurve as ModelParameters>::BaseField] = &[
        ...
        field_new!(Fq2, 
                   field_new!(Fq, "0"), 
                   field_new!(Fq, "2668273036814444928945193217157269437704588546626005256888038757416021100327225242961791752752677109358596181706522")), 
        field_new!(Fq2, 
                   ...
                   field_new!(Fq, "1334136518407222464472596608578634718852294273313002628444019378708010550163612621480895876376338554679298090853261")), 
        field_new!(Fq2, 
                   field_new!(Fq, "3557697382419259905260257622876359250272784728834673675850718343221361467102966990615722337003569479144794908942033"), 
                   field_new!(Fq, "0")),
    ];
    ...
    const PHI_X_DEN: &'static [<Self::IsogenousCurve as ModelParameters>::BaseField] = &[
        field_new!(Fq2, 
                   field_new!(Fq, "0"), 
                   field_new!(Fq, "4002409555221667393417789825735904156556882819939007885332058136124031650490837864442687629129015664037894272559715")), 
        field_new!(Fq2, 
                   field_new!(Fq, "12"), 
                   field_new!(Fq, "4002409555221667393417789825735904156556882819939007885332058136124031650490837864442687629129015664037894272559775")), 
        field_new!(Fq2, 
                   field_new!(Fq, "1"), 
                   field_new!(Fq, "0")),
    ];
    ...
    const PHI_Y_NOM: &'static [<Self::IsogenousCurve as ModelParameters>::BaseField] = &[
        ...
        field_new!(Fq2, 
                   field_new!(Fq, "0"), 
                   field_new!(Fq, "3112985209616852417102725420016814343988686637730339466369378550318691283715096116788757044878123294251695545324269")), 
        field_new!(Fq2, 
                   ...
                   field_new!(Fq, "2668273036814444928945193217157269437704588546626005256888038757416021100327225242961791752752677109358596181706524")), 
        field_new!(Fq2, 
                   field_new!(Fq, "1185899127473086635086752540958786416757594909611557891950239447740453822367655663538574112334523159714931636314011"), 
                   field_new!(Fq, "0")),
    ];
    ...
    const PHI_Y_DEN: &'static [<Self::IsogenousCurve as ModelParameters>::BaseField] = &[
        ...
        field_new!(Fq2, 
                   field_new!(Fq, "0"), 
                   field_new!(Fq, "4002409555221667393417789825735904156556882819939007885332058136124031650490837864442687629129015664037894272559571")), 
        field_new!(Fq2, 
                   field_new!(Fq, "18"), 
                   field_new!(Fq, "4002409555221667393417789825735904156556882819939007885332058136124031650490837864442687629129015664037894272559769")), 
        field_new!(Fq2, 
                   field_new!(Fq, "1"), 
                   field_new!(Fq, "0")),
    ];
